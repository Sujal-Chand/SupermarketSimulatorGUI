...
public class FreezerPanel extends JPanel {
    ...
    public FreezerPanel() {
        backgroundImage = loadImage("/freezer.png");
    ...
    private void populateShelf() {
        int x = 50, y = 160, w = 80, h = 80;
        int spacing = 100;

        for (PurchasableProduct product : GameState.instance().getProductManager().getFilteredPurchasableProducts(ProductStorageType.FROZEN)) {
